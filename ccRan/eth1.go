...
// Client1 defines typed wrappers for the Ethereum RPC API.
type Client1 struct {
...
// ToolConnect creates a client that uses the given host.
func ToolConnect1(host string, proxy ... string) (*Client1, error) {
...
func (ec *Client1) GetBlockNumber(ctx context.Context) (*big.Int, error) {
...
func (ec *Client1) SendTransaction(ctx context.Context, tx *Message) (common.Hash, error) {
...
// If the transaction was a contract creation use the TransactionReceipt method to get the
// contract address after the transaction has been mined.
func (ec *Client1) SendRawTransaction(ctx context.Context, tx *types.Transaction) (common.Hash, error) {
	var txHash common.Hash
...
func (ec *Client1) QueryTxByHash(ctx context.Context, txHash common.Hash) (withDrawTx WithdrawRPCTransaction, err error) {
...
func (ec *Client1) BaapQuery1(ctx context.Context, txData hexutil.Bytes) (result []byte, err error) {
	err = ec.rpcClient.CallContext(ctx, &result, "eth_baapQuery", txData)
	return

}

func (ec *Client1) QueryUncompletedTxByAddr(ctx context.Context, myaddr common.Address) (mytxhash []common.Hash) {
...
func (ec *Client1) GetCommitBlockByNum(ctx context.Context, number *big.Int) (block map[string]interface{}, err error) {
...
// 
func (ec *Client1) CheckTransaction(ctx context.Context, receiptChan chan *types.Receipt, txHash common.Hash, retrySeconds time.Duration) {
