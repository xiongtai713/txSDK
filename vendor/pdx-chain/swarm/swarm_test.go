...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/utopia.ipc",
			endpoint:    "/data/testnet/utopia.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/utopia.ipc",
			endpoint:    "/data/testnet/utopia.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/utopia.ipc",
			endpoint:    "/data/testnet/utopia.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/utopia.ipc",
			endpoint:    "/data/testnet/utopia.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
