...
func TestConsoleWelcome(t *testing.T) {
	...
	// Start a utopia console, make sure it's cleaned up and terminate the console
	geth := runGeth(t,
...
func TestIPCAttachWelcome(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		...
		ipc = filepath.Join(ws, "utopia.ipc")
	}
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	// Attach to a running utopia note and terminate immediately
