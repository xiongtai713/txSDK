...
import (
	...
	"pdx-chain/swarm"
	bzzapi "pdx-chain/swarm/api"
	swarmmetrics "pdx-chain/swarm/metrics"
	"pdx-chain/swarm/tracing"
	sv "pdx-chain/swarm/version"
...
// This init function sets defaults so cmd/swarm can run alongside utopia.
func init() {
...
var app = utils.NewApp(gitCommit, "PDX Utopia & Ethereum Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2018-2019 The PDX Utopia & Ethereum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//utopia only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for utopia and swarm
