...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "utopia.ipc", false, filepath.Join(os.TempDir(), "utopia.ipc")},
		{"data", "utopia.ipc", false, "data/utopia.ipc"},
		{"data", "./utopia.ipc", false, "./utopia.ipc"},
		{"data", "/utopia.ipc", false, "/utopia.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "utopia.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "utopia.ipc", true, `\\.\pipe\geth.ipc`},
